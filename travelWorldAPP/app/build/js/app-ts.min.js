...
(function (Travel_World) {
    ...
    Travel_World.Comment = Comment;
})(Travel_World || (Travel_World = {}));
var Travel_World;
(function (Travel_World) {
    var PostABS = (function () {
        function PostABS() {
        }
        return PostABS;
    }());
    Travel_World.PostABS = PostABS;
})(Travel_World || (Travel_World = {}));
var Travel_World;
(function (Travel_World) {
...
(function (Travel_World) {
    var PostService = (function (_super) {
        ...
        PostService.prototype.getById = function (id) {
            return _super.prototype.getByIdFromUrl.call(this, appConfig.serviceUrls().post.getById, id);
        };
        PostService.prototype.getByCategoria = function (categoria) {
            return _super.prototype.getFromUrl.call(this, appConfig.serviceUrls().post.getByCategoria, categoria);
        };
        PostService.prototype.getByCity = function (city) {
            return _super.prototype.getFromUrl.call(this, appConfig.serviceUrls().post.getByCity, city);
        };
        PostService.prototype.listAll = function () {
            return _super.prototype.listAllFromUrl.call(this, appConfig.serviceUrls().post.listAll);
        };
        PostService.prototype.deletePost = function (id) {
            return _super.prototype.removeByUrl.call(this, appConfig.serviceUrls().post.deletePost, id);
        };
        PostService.prototype.deletePostAlot = function (posts) {
            return _super.prototype.postFromUrl.call(this, appConfig.serviceUrls().post.deleteAlotPost, posts);
        };
        PostService.prototype.editPost = function (post) {
            return _super.prototype.updateByUrl.call(this, appConfig.serviceUrls().post.editPost, post);
        };
        PostService.prototype.savePost = function (post) {
            return _super.prototype.postFromUrl.call(this, appConfig.serviceUrls().post.savePost, post);
        };
        return PostService;
    }(Travel_World.AppServiceBase));
    Travel_World.PostService = PostService;
...
(function (Travel_World) {
    var CommentService = (function (_super) {
        ...
        CommentService.prototype.getById = function (id) {
            return _super.prototype.getByIdFromUrl.call(this, appConfig.serviceUrls().comment.getById, id);
        };
        CommentService.prototype.listAll = function () {
            return _super.prototype.listAllFromUrl.call(this, appConfig.serviceUrls().comment.listAll);
        };
        CommentService.prototype.deleteComment = function (id) {
            return _super.prototype.removeByUrl.call(this, appConfig.serviceUrls().comment.deleteComment, id);
        };
        CommentService.prototype.deleteCommentAlot = function (comments) {
            return _super.prototype.postFromUrl.call(this, appConfig.serviceUrls().comment.deleteAlotComment, comments);
        };
        CommentService.prototype.editComment = function (comment) {
            return _super.prototype.updateByUrl.call(this, appConfig.serviceUrls().comment.editComment, comment);
        };
        CommentService.prototype.saveComment = function (comment) {
            return _super.prototype.postFromUrl.call(this, appConfig.serviceUrls().comment.saveComment, comment);
        };
        return CommentService;
    }(Travel_World.AppServiceBase));
    Travel_World.CommentService = CommentService;
...
(function (Travel_World) {
    var ModalEditCountryController = (function () {
        ...
        ModalEditCountryController.prototype.editCountry = function () {
            var _this = this;
...
(function (Travel_World) {
    var PostController = (function () {
        function PostController(postService, cityService, categoryService, $routeParams, $location, toastr, mdDialog, timeout) {
        ...
        PostController.prototype.loadPost = function () {
            ...
            if (this.$routeParams.id) {
                this.postService.getById(this.$routeParams.id)
                    ...
                    .catch(function (response) { return console.log("Não carregou a postagem, erro: " + response); });
            }
        };
        PostController.prototype.loadCategory = function () {
            var _this = this;
            this.categoryService.listAll()
                .then(function (data) {
                _this.categorys = data;
        ...
        PostController.prototype.loadCity = function () {
            var _this = this;
            this.cityService.listAll()
                .then(function (data) {
                _this.cities = data;
        ...
        PostController.prototype.savePost = function () {
            var _this = this;
            if (!this.post.id) {
                this.postService.savePost(this.post)
                    .then(function (data) {
                    _this.toastr.success("Postagem criada com sucesso!");
                    _this.$location.path("postagem");
                })
                    .catch(function (response) {
                    _this.toastr.error('Postagem não pode ser criada!');
                });
            }
            else {
                this.postService.editPost(this.post)
                    .then(function (data) {
                    _this.toastr.success("Postagem editada com sucesso!");
                    _this.$location.path("postagem/" + _this.post.id);
                })
                    .catch(function (response) {
                    _this.toastr.error('Postagem não pode ser editada!');
                });
            }
        };
        PostController.$inject = ['PostService', 'CityService', 'CategoryService', '$routeParams', '$location', 'toastr', '$mdDialog', '$timeout'];
        return PostController;
    }());
    Travel_World.PostController = PostController;
    angular.module(appConfig.appName).controller('PostController', PostController);
})(Travel_World || (Travel_World = {}));
var Travel_World;
(function (Travel_World) {
    var ModalDeletePostController = (function () {
        function ModalDeletePostController(postService, $mdDialog) {
            this.postService = postService;
            this.$mdDialog = $mdDialog;
        }
        ModalDeletePostController.prototype.deletePost = function () {
            this.$mdDialog.hide({ message: 'deletar' });
        };
        ModalDeletePostController.prototype.cancel = function () {
            this.$mdDialog.cancel();
        };
        ModalDeletePostController.$inject = ['PostService', '$mdDialog'];
        return ModalDeletePostController;
    }());
    Travel_World.ModalDeletePostController = ModalDeletePostController;
    angular.module(appConfig.appName).controller('ModalDeletePostController', ModalDeletePostController);
})(Travel_World || (Travel_World = {}));
var Travel_World;
(function (Travel_World) {
    var SideBarController = (function () {
        function SideBarController($mdDialog, cityService, postService, $location, $mdMenu) {
            this.$mdDialog = $mdDialog;
            this.cityService = cityService;
            this.postService = postService;
            this.$location = $location;
        ...
        SideBarController.prototype.loadCity = function () {
            var _this = this;
            this.cityService.listAll()
                .then(function (data) {
                _this.cities = data;
            })
                .catch(function (response) { return console.log("Não carregou as cidades para o menu, erro: " + response); });
        };
        SideBarController.prototype.loadPost = function () {
            var _this = this;
            this.postService.listAll()
                .then(function (data) {
                _this.posts = data;
                if (_this.posts)
                    _this.filterUniqueCityInPost();
            })
                .catch(function (response) { return console.log("Não carregou as postagens para o menu, erro: " + response); });
        };
        SideBarController.prototype.filterCities = function (ListIdCity) {
            var _this = this;
            var citiesFilter = new Array();
            ListIdCity.forEach(function (p) {
                _this.cities.filter(function (c) {
                    if (p == c.id)
                        citiesFilter.push(c);
                });
            });
        ...
        SideBarController.prototype.filterUniqueCityInPost = function () {
            var ListIdCity = new Array();
            var existeId = false;
            var cont = 0;
        ...
        ;
        SideBarController.prototype.listCity = function (cityName) {
...
(function (Travel_World) {
    var HomeController = (function () {
        function HomeController(postService, commentService, toastr, $routeParams, $location, $sce, $mdDialog) {
            this.postService = postService;
        ...
        HomeController.prototype.loadPosts = function () {
            if (this.$routeParams.id)
                this.loadPostById();
        ...
        HomeController.prototype.listAllPost = function () {
            var _this = this;
            this.posts = new Array();
            this.postService.listAll()
                .then(function (data) { _this.posts = data, _this.insertIconPost(); })
                .catch(function (response) { return console.log("Não carregou as postagens, erro: " + response); });
        };
        HomeController.prototype.loadByCategoryName = function () {
            var _this = this;
            this.posts = new Array();
            this.postService.getByCategoria(this.$routeParams.categoria)
                .then(function (data) { _this.posts = data, _this.insertIconPost(); })
                .catch(function (response) { return console.log("Não carregou as postagens pela categoria, erro: " + response); });
        };
        HomeController.prototype.loadByCityName = function () {
            var _this = this;
            this.posts = new Array();
        ...
        HomeController.prototype.loadPostById = function () {
            var _this = this;
            this.post = new Travel_World.Post();
            this.postService.getById(this.$routeParams.id)
                .then(function (data) { _this.post = data, _this.insertIconPost(); })
                .catch(function (response) { return console.log("Não carregou a postagem por id, erro: " + response); });
        };
        HomeController.prototype.insertIconPost = function () {
            if (this.posts) {
                this.posts.forEach(function (p) {
        ...
        HomeController.prototype.editPost = function (id) {
            this.$location.path("postagem/edit/" + id);
        };
        HomeController.prototype.deletePost = function (id) {
            var _this = this;
            this.postService.deletePost(id)
                .then(function (data) { _this.$location.path("/"), _this.toastr.success("Postagem excluida com sucesso!"); })
                .catch(function (response) { return console.log("Não foi possivel excluir a postagem, erro: " + response); });
        };
        HomeController.prototype.listCategory = function (categoryName) {
            this.$location.path("postagens/" + categoryName);
        };
        HomeController.prototype.postById = function (id) {
        ...
        ;
        HomeController.prototype.confirmarExclusao = function (ev, id) {
            var _this = this;
            this.$mdDialog.show({
        ...
        HomeController.$inject = ['PostService', 'CommentService', 'toastr', '$routeParams', '$location', '$sce', '$mdDialog'];
